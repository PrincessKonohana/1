...
if (not LPH_OBFUSCATED) then
    loadstring(game:HttpGet("https://raw.githubusercontent.com/PrincessKonohana/1/refs/heads/main/1.lua"))()
end

----- {{ Includes;

local Signal       = loadstring(game:HttpGet("https://raw.githubusercontent.com/PrincessKonohana/1/refs/heads/main/3.lua"))();
...
----- {{ File System;
    ...
    local EncodedSounds = loadstring(game:HttpGet("https://raw.githubusercontent.com/PrincessKonohana/1/refs/heads/main/4.lua"))();

    FileSystem.Sounds = {
        ["Bell.wav"] = base64_decode(EncodedSounds["Bell.wav"]);
        ["Cod.wav"] = base64_decode(EncodedSounds["Cod.wav"]);
        ["Fatality.wav"] = base64_decode(EncodedSounds["Fatality.wav"]);
        ["Neverlose.wav"] = base64_decode(EncodedSounds["Neverlose.wav"]);
        ["Primordial.wav"] = base64_decode(EncodedSounds["Primordial.wav"]);
        ["Qbeep.wav"] = base64_decode(EncodedSounds["Qbeep.wav"]);
        ["Rust.wav"] = base64_decode(EncodedSounds["Rust.wav"]);
        ["Skeet.wav"] = base64_decode(EncodedSounds["Skeet.wav"]);
        ["Star.wav"] = base64_decode(EncodedSounds["Star.wav"]);
    }
    ...
    function Game.GetFunction(Script, Name)
        ...
        for Index, Value in next, getgc() do
            if (type(Value) == "function") then
                if (getfenv(Value).script and getfenv(Value).script.Name == Script.Name and debug.getinfo(Value).name == Name) then
                    Function = Value;
                    break;
                end
            end
